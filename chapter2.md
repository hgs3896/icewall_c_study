...
이 프로그램을 실행시켜보면, '안녕 세상아'라는 메시지를 투박하기 그지 없는 까만 '**콘솔**'창에 출력해주었어요.
...
2. 앞에 붙은 int는 뭘까요? 여러분들이 생각하는 바로 그 것이에요.
...
그런데 생각해보면 내가 평소에 남들에게 하는 말이 항상 정확하게 다른 사람에게 동일한 의미로 전달되나요?
...
가령, 숫자 17을 컴퓨터에서 저장할 때, 8비트\(2진수 8자리\)로 표현하면 00010001 으로 나타낼 수 있습니다.

그런데 이걸 4비트\(2진수 4자리\)씩 끊어서 읽는다면 0001 0001, 즉 11을 나타낼 수도 있습니다.
