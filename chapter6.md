...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오전 10.10.44.png)
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오전 10.23.58.png)
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오전 10.25.59.png)
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오전 10.41.58.png)
...
```
int *arr2; // 포인터를 배열 처럼도 사용 가능.


for(int i=0 ; i<2 ;i++) {
    (arr2+i)=i; //arr[0]=0, arr[1]=1, arr[2]=2 이런식으로포인터를 배열처럼도쓸수있다
}
```
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오전 10.49.24.png)
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오후 12.51.17.png)
...
for(int i=0 ; i<5 ; i++){
    ...
    printf("%d\n",*(ptr+i)); // 포인터를 이용해 배열 접근. *(ptr+i)==arr[i].
}
...
![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오후 12.51.33.png)![](https://newrim.gitbooks.io/c-study_icewall/content/assets/스크린샷 2017-05-16 오후 12.55.20.png)
