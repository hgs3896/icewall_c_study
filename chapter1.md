...
#### : **프로그래밍과 프로그래밍 언어의 발전, **C vs Python, C로 된 프로그램 만들기

## 1. **프로그래밍과 프로그래밍 언어의 발전**

* #### 프로그래밍\(Programming = Program + ing\)이란 무엇일까?
* #### 간단하게 말하면, 인간이\(혹은 내가\) 생각하는 것을 컴퓨터도 알아먹을 수 있는 형태인 코드로 표현하는 것이다.
